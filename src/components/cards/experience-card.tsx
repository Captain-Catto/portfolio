      ...
      <div className="pt-4 pb-2 h-full flex flex-col">
        ...
        <div className="border-b-2 border-border pb-2 px-4 flex-shrink-0">
          <div className="flex justify-center items-center gap-2">
            <BsSuitcaseLg className="text-primary size-5" />
              ...
              {experiences.map((exp) => {
                ...
                return (
                  <div
                    key={exp.id}
                    className={cn(
                      "select-none rounded-2xl border-2 border-border p-3 bg-card-secondary",
                  ...
                  >
                    <div className="relative flex justify-between gap-1 border-b-2 border-border pb-2">
                      <div className="flex items-start flex-col overflow-hidden">
                        <h3 className="font-medium text-xs text-foreground overflow-hidden text-ellipsis whitespace-nowrap">
                          {exp.title}
                        </h3>
                    ...
                    <ul className={cn(
                      "font-medium text-xs text-foreground/70 text-left pt-2 space-y-1",
